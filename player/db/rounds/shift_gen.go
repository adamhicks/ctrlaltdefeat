...
// updateRound receiver are updated, as well as status and updated_at. 
// The entity id is returned on success or an error.
func (一 updateRound) Update(ctx context.Context, tx *sql.Tx,from shift.Status, 
	...
	if n != 1 {
		return 0, errors.Wrap(shift.ErrRowCount, "updateRound", j.KV("count", n))
	}
